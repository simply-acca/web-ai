  ...
  return (
    <div className="relative isolate overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-50 to-white p-8 dark:from-emerald-950/20 dark:to-gray-950">
      <div className="mx-auto max-w-5xl py-16">
        <p className="text-sm uppercase tracking-wider text-emerald-600">Learn ACCA with AI</p>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <a href="/pricing" className="rounded-xl bg-emerald-600 px-5 py-3 font-semibold text-white hover:bg-emerald-500">Start your plan</a>
          <a href="/papers" className="rounded-xl border px-5 py-3 hover:border-emerald-400">Explore papers</a>
        </div>
