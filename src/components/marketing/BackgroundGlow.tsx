export default function BackgroundGlow() {
  ...
  return (
    ...
    >
      {/* large radial glows */}
      <div className="absolute -left-40 -top-40 h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.25),transparent_60%)] blur-2xl" />
      ...
      <div className="absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(20,184,166,0.18),transparent_60%)] blur-3xl" />
